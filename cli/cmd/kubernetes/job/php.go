...
func (p *phpCreator) create(targetPod *apiv1.Pod, cfg *data.FlameConfig) (string, *batchv1.Job, error) {
	...
	if cfg.TargetConfig.Image != "" {
		...
		imageName = fmt.Sprintf("%s:%s-php", baseImageName, version.GetCurrent())
	}
